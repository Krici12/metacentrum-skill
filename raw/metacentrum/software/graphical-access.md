...
## [gui module - quick start](#gui-module---quick-start)
...
#### [Start an interactive job](#start-an-interactive-job)
...
#### [Load the gui module and start it](#load-the-gui-module-and-start-it)
...
![Login process in a browser](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbrowser-login.1zuj-vpoc_d6r.png&w=3840&q=75)
...
#### [Logout in the end](#logout-in-the-end)

The session will remain open until you log out or until the walltime runs out.

![Logout from the session](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsession-logout.1n7w8m1767-89.png&w=3840&q=75)

### [Using a VNC session](#using-a-vnc-session)

Another easy way how to start GUI is via some VNC client. The following brief tutorial utilizes the TightVNC client.

#### [Start an interactive job](#start-an-interactive-job-1)
...
#### [Load the gui module and start it](#load-the-gui-module-and-start-it-1)
...
#### [Open a VNC connection](#open-a-vnc-connection)

In the client interface, fill all required values according to the output of `gui start` command.

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVNC-new.2y1nezjh23_nt.png&w=3840&q=75)

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVNC-udaje.40zvss9iwb62c.png&w=3840&q=75)

Click on the Connect button and, if necessary, agree with the access to the unknown machine.

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVNC-ssh.2h1_h5tsqokp9.png&w=3840&q=75)
...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVNC-heslo-meta.3-xnqtay3ubcd.png&w=3840&q=75)

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVNC-heslo-vnc.2gaq7eja4wks_.png&w=3840&q=75)

Finally, click on Login button and the GUI session will start.

#### [Logout in the end](#logout-in-the-end-1)

The session will remain open until you log out or until the walltime runs out.

![Logout from the session](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsession-logout.1n7w8m1767-89.png&w=3840&q=75)

## [gui module - details](#gui-module---details)

#### [VNC session vs SSH tunneling](#vnc-session-vs-ssh-tunneling)
...
| -g 3840x2160
window maximized |-g 3840x2160
fullscreen mode |-g 1920x1080
window maximized |
| ![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVnc-fhd-doubled-even.1ht5b9qaehyog.jpg&w=3840&q=75) |![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVnc-fhd-doubled.3xycjs5i_c_a6.jpg&w=3840&q=75) |![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVnc-uhd-bigger-font.39itv14cvqsi8.jpg&w=3840&q=75) |

| -g 1920x1080
fullscreen mode |-g 3840x2160
increased fonts |
| ![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVnc-uhd-even.1nmc0qz9p5jn8.jpg&w=3840&q=75) |![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FVnc-uhd-uneven.354vhv03cet9t.jpg&w=3840&q=75) |

#### [gui command options](#gui-command-options)
...
#### [Long-standing desktop session](#long-standing-desktop-session)
...
#### [Connect with Putty in Windows](#connect-with-putty-in-windows)
...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FPutty-tunnel.0o26h6p5nd4ix.png&w=3840&q=75)

#### [Connect with remote desktop: Windows 10 and newer](#connect-with-remote-desktop-windows-10-and-newer)
...
Installed [X Server environment](https://sourceforge.net/projects/vcxsrv/) on your computer with Windows. You can directly download the latest version from this page.

-

Installed Windows Subsystem for Linux (WSL), version 1 or 2. You can find many tutorials describing this step on the Internet, e.g. [https://docs.microsoft.com/en-us/windows/wsl/install-win10](https://docs.microsoft.com/en-us/windows/wsl/install-win10). Following steps are tested on Linux distribution [Ubuntu 18.04 LTS](https://www.microsoft.com/cs-cz/p/ubuntu-1804-lts/9n9tngvndl3q) and [Ubuntu 20.04 LTS](https://www.microsoft.com/cs-cz/p/ubuntu-2004-lts/9n6svws3rx71).
...
#### [Connect VNC in Linux](#connect-vnc-in-linux)
...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsplash-screen.0ht6kj0ry9gxb.png&w=3840&q=75)
...
### [X-protocol tunneling](#x-protocol-tunneling)
...
### [Direct connection by X-protocol](#direct-connection-by-x-protocol)
...
### On this page
[gui module - quick start](#gui-module---quick-start)[Using a web browser](#using-a-web-browser)[Start an interactive job](#start-an-interactive-job)[Load the gui module and start it](#load-the-gui-module-and-start-it)[Open a browser](#open-a-browser)[Logout in the end](#logout-in-the-end)[Using a VNC session](#using-a-vnc-session)[Start an interactive job](#start-an-interactive-job-1)[Load the gui module and start it](#load-the-gui-module-and-start-it-1)[Open a VNC connection](#open-a-vnc-connection)[Logout in the end](#logout-in-the-end-1)[gui module - details](#gui-module---details)[VNC session vs SSH tunneling](#vnc-session-vs-ssh-tunneling)[Desktop resolution](#desktop-resolution)[gui command options](#gui-command-options)[VNC clients](#vnc-clients)[Long-standing desktop session](#long-standing-desktop-session)[Connect with Putty in Windows](#connect-with-putty-in-windows)[Connect with remote desktop: Windows 10 and newer](#connect-with-remote-desktop-windows-10-and-newer)[Connect VNC in Linux](#connect-vnc-in-linux)[X-window](#x-window)[X-protocol tunneling](#x-protocol-tunneling)[Windows](#windows)[Linux](#linux)[Direct connection by X-protocol](#direct-connection-by-x-protocol)
