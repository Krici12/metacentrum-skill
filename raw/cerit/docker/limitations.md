...
- Run `chown -R uid /etc /lib* /usr /var /bin` during docker build process. Replace `uid` with real user id, e.g., 1000.
...
### On this page
[No Root](#no-root)[Consequences](#consequences)
