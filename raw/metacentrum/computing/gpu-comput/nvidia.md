...
## [Run as Singularity image](#run-as-singularity-image)
...
### [From CVMFS as interactive job](#from-cvmfs-as-interactive-job)
...
### [From CVMFS as regular batch job](#from-cvmfs-as-regular-batch-job)

Prepare e.g. runPyTorch_job.sh script to run calculation within PyTorch image:
...
### [From dockerhub as interactive job](#from-dockerhub-as-interactive-job)
...
### [Re-running image from Singularity cache](#re-running-image-from-singularity-cache)
...
- Versions of NGC images requiring CUDA version higher than 11.0 are not supported (see [https://my.metacentrum.cz/machines](https://my.metacentrum.cz/machines) and search for Resource -> cuda_version)

- Customizing images is possible. See Singularity

- In case you would add NGC image or your own image to cmvfs, write ticket to [meta@cesnet.cz](mailto:meta@cesnet.cz).

### [Get NGC API key](#get-ngc-api-key)
...
### [Job scripts for JupyterLab](#job-scripts-for-jupyterlab)
...
### On this page
[Run as Singularity image](#run-as-singularity-image)[From CVMFS as interactive job](#from-cvmfs-as-interactive-job)[From CVMFS as regular batch job](#from-cvmfs-as-regular-batch-job)[From dockerhub as interactive job](#from-dockerhub-as-interactive-job)[Re-running image from Singularity cache](#re-running-image-from-singularity-cache)[Notes](#notes)[Get NGC API key](#get-ngc-api-key)[Build Singularity image](#build-singularity-image)[Job scripts for JupyterLab](#job-scripts-for-jupyterlab)
