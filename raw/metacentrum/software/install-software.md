...
Often users try to install a minor and easy-looking software locally and fail. **This is very common.** If this happens (and you still want to keep the installation to your home directory), do not hesitate to contact User support at [meta@cesnet.cz](mailto:meta@cesnet.cz) for help. They will reproduce the errors you get, find a solution and send it back to you in step-by-step guide. *Any installation process, no matter how straightforward it looks at the beginning, can get tricky.*

### [System-wide installation](#system-wide-installation)

*This option means that the user sends request for software installation to [meta@cesnet.cz](mailto:meta@cesnet.cz). The User support team will install the software into system directories and make a modulefile through which the software can be loaded.*
...
## [Common installation methods](#common-installation-methods)
...
Use `--user` option rather that `--root` during pip install
...
### [Conda/Mamba packages](#condamamba-packages)
...
[Conda](https://conda.io), available through ``[mambaforge](../software/sw-list/mambaforge) and ``[conda-modules/](../software/sw-list/conda-modules) module, is an open-source package management and environment management system that is commonly used in the Python programming ecosystem.

[Mamba](https://anaconda.org/conda-forge/mamba), available through ``[mambaforge module](../software/sw-list/mambaforge), is a package manager and environment manager that is designed to be a faster and more efficient drop-in replacement for Conda. Both Conda and Mamba are closely related, as Mamba was developed as an open-source project to address some of the performance limitations of Conda.
...
### [Compile from source (C, C++, Fortran)](#compile-from-source-c-c-fortran)
...
- PGI compiler - another commercial compiler with optimized math libraries for AMD clusters(search for `cpu_vendor=amd`).
...
### On this page
[General options](#general-options)[Local installation](#local-installation)[System-wide installation](#system-wide-installation)[Common installation methods](#common-installation-methods)[Binaries](#binaries)[R packages](#r-packages)[Debian packages](#debian-packages)[Perl modules](#perl-modules)[Python packages](#python-packages)[Conda/Mamba packages](#condamamba-packages)[Containers](#containers)[Compile from source (C, C++, Fortran)](#compile-from-source-c-c-fortran)
