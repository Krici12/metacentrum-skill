...
idea of how data is handled in MetaCentrum. This article contains a brief but
...
Please note that MetaCentrum storages are not suitable for medical data, other sensitive data, data with NDA, etc. To work with this kind of data (storage and computing), use the [SensitiveCloud](https://docs.e-infra.cz/compute/sensitive-cloud/) service.

## [Within MetaCentrum](#within-metacentrum)
...
## [Outside of MetaCentrum](#outside-of-metacentrum)

### [Object storage](#object-storage)

Should your data exceed the capacities available as home directories, you can consider using services of generic data storage facilities available in the infrastructure and operated by the [Data Storage Department](https://docs.du.cesnet.cz/en/docs/introduction/introduction). That is a system of large capacity **object storage facilities** typically accessed through S3 protocol. Object storages **can be used both for high capacities as well as longer-term data storage**. Requirements exceeding 10 TB (or even hundreds TB) and years of storage time are generally possible, they should nevertheless be discussed individually.

### [National repository platform (NRP)](#national-repository-platform-nrp)

For **long-term data storage**, the **[National repository platform](https://www.eosc.cz/en/projects/national-repository-platform-for-research-data-os-i-nrp/national-repository-platform)** is being built, providing repositories. NRPs are storage systems for data equipped with rich metadata that help make the data findable, accessible, interoperable, and reusable (FAIR data).

![publicity banner](/_next/static/media/einfra_meta-zapati.0m5s8338yq376.svg)

### On this page
[Within MetaCentrum](#within-metacentrum)[Scratch directories](#scratch-directories)[Home directories](#home-directories)[Outside of MetaCentrum](#outside-of-metacentrum)[Object storage](#object-storage)[National repository platform (NRP)](#national-repository-platform-nrp)
