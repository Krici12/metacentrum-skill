...
- `sftp user123@target_NFS4_server` # Login

- `help` List available commands

- `get target_file` Download target file to your local system

- `get -r target_directory` Download target directory to your local system

- `put target_file` Upload target file to server

- `put -r target_directory` Upload target directory to server
...
## [Moderate data handling](#moderate-data-handling)
...
![Copy data to storage through frontend](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcp-data-through-frontend_border.1a26o_fc_is3y.jpg&w=3840&q=75)
...
### [Move data to/from a storage](#move-data-tofrom-a-storage)
...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcp-data-directly-storage_border.3ahvo0lcdf7dq.jpg&w=3840&q=75)
...
### [Move data between storages](#move-data-between-storages)
...
### On this page
[Useful commands](#useful-commands)``[scp](#scp)``[wget](#wget)``[sftp](#sftp)``[rsync](#rsync)``[tar](#tar)[Moderate data handling](#moderate-data-handling)[Large data handling](#large-data-handling)[Move data to/from a storage](#move-data-tofrom-a-storage)[Move data between storages](#move-data-between-storages)[scp](#scp-1)[rsync](#rsync-1)
