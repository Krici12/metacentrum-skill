...
## [Find your large data](#find-your-large-data)

### ``[ncdu2 tool](#ncdu2-tool)
...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fncdu2-default-view.1bxzv7vauawy8.png&w=3840&q=75)

By pressing `?` the help will be displayed.

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fncdu2-help.2-xgi5zgx6ygc.png&w=3840&q=75)

### [List by size](#list-by-size)

If you need to locate where most of the volume resides, press `s`.

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fncdu2-list-by-size.3hsauumjovc66.png&w=3840&q=75)

### [List by number of files](#list-by-number-of-files)

If you need to locate directories with large number of files, press `c`, then `C`.

![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fncdu2-list-by-nfiles.0kradf_3rruux.png&w=3840&q=75)

## [When you exceed a quota](#when-you-exceed-a-quota)
...
### [Pack small files into large chunks](#pack-small-files-into-large-chunks)
...
### [Archive the data](#archive-the-data)
...
### [Move the data to another storage](#move-the-data-to-another-storage)
...
## [Root filesystem quota](#root-filesystem-quota)

### [What is root filesystem quota](#what-is-root-filesystem-quota)
...
### [How to clear files filling the quota](#how-to-clear-files-filling-the-quota)
...
### [How to prevent the situation](#how-to-prevent-the-situation)
...
### On this page
[Find your large data](#find-your-large-data)``[ncdu2 tool](#ncdu2-tool)[Get the database](#get-the-database)[Display the database](#display-the-database)[List by size](#list-by-size)[List by number of files](#list-by-number-of-files)[When you exceed a quota](#when-you-exceed-a-quota)[Delete it](#delete-it)[Pack small files into large chunks](#pack-small-files-into-large-chunks)[Archive the data](#archive-the-data)[Move the data to another storage](#move-the-data-to-another-storage)[Root filesystem quota](#root-filesystem-quota)[What is root filesystem quota](#what-is-root-filesystem-quota)[How to clear files filling the quota](#how-to-clear-files-filling-the-quota)[How to prevent the situation](#how-to-prevent-the-situation)
