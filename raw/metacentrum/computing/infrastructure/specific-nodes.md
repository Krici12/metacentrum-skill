...
Oven (`oven.metacentrum.cz`) is a new special frontend which is available through [oven queue](https://my.metacentrum.cz/queues/oven@pbs-m1.metacentrum.cz). It is dedicated for non-demanding jobs (control/re-submitting of jobs).
