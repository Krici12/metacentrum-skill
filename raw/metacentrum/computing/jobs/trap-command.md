...
![pic](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftrap-command-scheme_border.3jnzdfslv2wrl.jpg&w=3840&q=75)
...
## [Trap both EXIT and TERM](#trap-both-exit-and-term)
...
### On this page
[Trap the EXIT](#trap-the-exit)[Trap the TERM](#trap-the-term)[Trap both EXIT and TERM](#trap-both-exit-and-term)[Caveats](#caveats)
