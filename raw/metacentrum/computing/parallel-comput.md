...
### [Use InfiniBand connection](#use-infiniband-connection)
...
### [MPI and OpenMP interaction](#mpi-and-openmp-interaction)
...
| 1 device, more processors |`export OMP_NUM_THREADS=$PBS_NUM_PPN`
 `mpirun -n 1 /path/to/program ...` |
| 1 device, more processors |`export OMP_NUM_THREADS=1`
 `mpirun /path/to/program ...` |
| 2 device, more processors |`cat $PBS_NODEFILE |

![publicity banner](/_next/static/media/einfra_meta-zapati.0m5s8338yq376.svg)

### On this page
[OpenMP](#openmp)[MPI](#mpi)[Use InfiniBand connection](#use-infiniband-connection)[MPI and OpenMP interaction](#mpi-and-openmp-interaction)
