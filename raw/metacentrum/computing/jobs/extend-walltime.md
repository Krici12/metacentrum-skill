...
CPU-hours are not walltime hours
...
If you reach the monthly limit and still need to prolong a job, it can be done upon request to user support at [meta@cesnet.cz](mailto:meta@cesnet.cz).

How do I extend the array job?

The `qextend` command can be used to extend simple jobs only. If you need to extend the array job, let us know at [meta@cesnet.cz](mailto:meta@cesnet.cz) user support.
